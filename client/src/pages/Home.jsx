    ...
    <div className="min-h-screen overflow-hidden bg-white text-black">
      ...
      <section className="max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div>
          ...
          >
            <motion.h1
              className="
                text-5xl lg:text-6xl font-extrabold leading-tight
                bg-gradient-to-br
            ...
            onClick={()=>navigate("/notes")}
              ...
              className="
                ...
                bg-gradient-to-br
                from-black/90 via-black/80 to-black
      ...
      <section className="max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10">
        <Feature
                icon="📖"
                title="Exam Notes"
                des="Highyield exam-oriented notes with revison points."
            />

            <Feature
                icon="📂"
                title="Project Notes"
                des="Well structered content for assignments and projects."
            />
