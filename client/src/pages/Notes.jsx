...
function Notes() {
  ...
  const [loading,setLoading] = useState(false); // To call API
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      ...
      className='h-64 rounded-2xl flex flex-col items-center justify-center border border-dashed border-gray-300 text-gray-500 shadow-inner'>
