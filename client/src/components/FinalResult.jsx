...
const markDownComponent = {
  ...
  // By default, when react-markdown parses a #  token, it says "Okay, I need to render a standard <h1> tag." By defining your custom configuration object
  h1: (
    { children }, 
  ) => (
...
function FinalResult({ result }) {
  const [quickRevision, setQuickRevision] = useState(false); // if true then we will only show topics for revision.
  ...
  return (
    <div className="mt-6 p-3 space-y-10 bg-white">
      ...
      {!quickRevision &&  <section>
        <SectionHeader icon='📝' title="Notes" color="purple" />
    ...
    {quickRevision && <section className="rounded-xl bg-gradient-to-r from-green-100 to-green-50 border border-green-200 p-6">
        ...
        {result.diagram?.data && <section>
            ...
            <p className="mt-3 text-xs text-gray-500 italic">
                If you need this diagram for future refrence or revision, you can save it by taking a screenshot
            </p>
            </section>}
